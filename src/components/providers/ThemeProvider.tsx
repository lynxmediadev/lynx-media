...
export default function ThemeToggle() {
  // Estado inicial neutro; se fija al montar (cliente).
  const [theme, setTheme] = useState<Theme>("light");
  const isDark = theme === "dark";

  // Al montar en cliente, sincroniza con localStorage y media query.
  useEffect(() => {
    const initial = getPreferredTheme();
    setTheme(initial);
  }, []);

  // Efecto: aplica/remueve la clase en <html> y persiste en localStorage.
  useEffect(() => {
